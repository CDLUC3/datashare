...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template name="metadata">
      <meta http-equiv="Content-Type" name="title"
         content="{eadheader/filedesc/titlestmt/titleproper&#x20; }{eadheader/filedesc/titlestmt/subtitle}"/>
      <meta http-equiv="Content-Type" name="author" content="{archdesc/did/origination}"/>
      
      <xsl:for-each select="xtf:meta/subject">
         <meta http-equiv="Content-Type" name="subject" content="{.}"/>
      </xsl:for-each>
      
      <meta http-equiv="Content-Type" name="title" content="{archdesc/did/unittitle}"/>
      <meta http-equiv="Content-Type" name="type" content="text"/>
      <meta http-equiv="Content-Type" name="format" content="manuscripts"/>
      <meta http-equiv="Content-Type" name="format" content="finding aids"/>
